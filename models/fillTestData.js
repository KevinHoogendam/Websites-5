...
function fillTestRaces(Race, done){
	var testData = [
		{ name: 'raceeee', waypoints: [{googleId: '110ea987dfe7e26956c1fc27f163abb18168bed3', name: 'Starbucks De Meern'}]},
		{ name: 'zuipen', waypoints: [{googleId: '80f43809517d9dc47d9e20d2cd6f5c52ef749d5f', name: 'Hotel De Gouden Leeuw'}]},
		{ name: 'geen kinderspel', waypoints: [{googleId: '9d9917b44e35cdd81ac66b9ee897b5308b9a2a5e', name: 'BP'}]},
	];
